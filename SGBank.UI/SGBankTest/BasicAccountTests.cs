...
namespace SGBankTest
{
    ...
    public class BasicAccountTests
    {
        ...
        [TestCase ("33333", "Basic Accoung", 100, AccountType.Basic, 250, true)]
        public void BasicAccountDepositRuleTest(string accountNumber, string name, decimal balance, AccountType acountType, decimal amount, bool expectedResult)
        {
